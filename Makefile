...
windows: differentiator_windows logging_windows construct_graphics_windows recursive_descent_windows latex_output_windows simplifying
	g++ main.cpp Obj/Differentiator.o Obj/Logging.o Obj/ConstructGraphics.o Obj/LatexOutput.o Obj/RecursiveDescent.o Obj/Simplifying.o $(C_FLAGS_WINDOWS) -o Exe/Start.exe
