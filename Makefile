...
windows: differentiator_windows logging_windows construct_graphics_windows recursive_descent_windows
	g++ main.cpp Obj/Differentiator.o Obj/Logging.o Obj/ConstructGraphics.o Obj/RecursiveDescent.o $(C_FLAGS_WINDOWS) -o Exe/Start.exe

construct_graphics_windows:
	g++ -c Differentiator/Libs/ConstructGraphics/ConstructGraphics.cpp $(C_FLAGS_WINDOWS) -o Obj/ConstructGraphics.o
