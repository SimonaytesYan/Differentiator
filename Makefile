...
windows: differentiator_windows logging_windows construct_graphics_windows
	g++ main.cpp Obj/Differentiator.o Obj/Logging.o Obj/ConstructGraphics.o $(C_FLAGS_WINDOWS) -o Exe/Start.exe
